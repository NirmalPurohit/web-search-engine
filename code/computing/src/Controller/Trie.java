/*
 * TST implementation to store dicationary and search the keyword
 * Code is utilized from the class source code on Blackboard
 */
package Controller;
...
public class Trie<Value> {
    ...
    **************************************************************/
    ...
    public Iterable<String> keys() {
        que<String> queue = new que<String>();
        collect(root, "", queue);
        return queue;
    }
    ...
    private void collect(Node x, String prefix, que<String> queue) {
        if (x == null) return;
    ...
    private void collect(Node x, String prefix, int i, String pat, que<String> q) {
        if (x == null) return;
        char c = pat.charAt(i);
